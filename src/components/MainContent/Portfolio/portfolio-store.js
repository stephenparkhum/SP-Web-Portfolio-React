let portfolioStore = [
    {
        id: 1,
        title: 'Maestus (2020)',
        description: `The 2020 official site for Portland, OR band Maestus.`,
        imgSrc: 'http://drive.google.com/uc?export=view&id=1eLUHomqpv4-awllk01NwouZo_wOMnHnZ',
        liveLink: 'http://maest.us',
        ghLink: 'https://github.com/stephenparkhum/Maestus-2020',
        tags: ['React', 'JavaScript', 'HTML5', 'SASS'],
        year: '2020'
    },
    {
        id: 2,
        title: 'Glossolalia Records (2020)',
        description: `The 2020 re-design of the Glossolalia Records website.`,
